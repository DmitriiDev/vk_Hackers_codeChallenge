...
class CommentTableViewCell: SwipeTableViewCell {
    ...
    override func awakeFromNib() {
        ...
        upvoteIconImageView?.image = UIImage(named: "PointsIcon")?
         ...
         authorLabel?.accessibilityLabel = "authorLabelID"
         datePostedLabel?.accessibilityLabel = "datePostedLabelID"
         upvoteIconImageView?.accessibilityLabel = "upvoteIconImageViewID"
    }
